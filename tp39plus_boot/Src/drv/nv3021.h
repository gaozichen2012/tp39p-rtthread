...
//LCD背光控制引脚的端口和pin
/*
#define LCD_BACKLIGHT_CTL_PORT	GPIOC
#define LCD_BACKLIGHT_CTL_PIN		GPIO_Pin_13
...
#define	LCD_BK_REVERSE()	if(LCD_BK_READ())	\
							...
							LCD_BK_ON();	\
*/
#define LCD_BK_OFF()	 conr_val595.conr_bit.LCD_BL = 0
#define LCD_BK_ON()  	 conr_val595.conr_bit.LCD_BL = 1
